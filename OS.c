...
#define SPEED_UPDATE_PERIODICITY_MS         (0x3E8) /* 1000 MS */
#define COM_UPDATE_PERIODICITY_MS         (0x3E8) /* 1000 MS */
...
void OS_Init(void)
{
	...
	index++;
    /* ************* OS Task 0x01 ************* */
    OS_TaskList[index].periodicity_ms = SPEED_UPDATE_PERIODICITY_MS;
    OS_TaskList[index].process = Speed_Update;
    index++;
    /* ************* OS Task 0x01 ************* */
    OS_TaskList[index].periodicity_ms = COM_UPDATE_PERIODICITY_MS;
    OS_TaskList[index].process = COM_Update;
    index++;
